function fix_view_position(_view_number) {
  ...
  if (!view_enabled || !instance_exists(__view_get(e__VW.Object, _view_number)))
    exit;
  ...
  __view_set(
    ...
    max(
      0,
      min(
        room_width - __view_get(e__VW.WView, _view_number),
        __view_get(e__VW.XView, _view_number)
      )
    )
  );
  __view_set(
    ...
    max(
      0,
      min(
        room_height - __view_get(e__VW.HView, _view_number),
        __view_get(e__VW.YView, _view_number)
      )
    )
  );
