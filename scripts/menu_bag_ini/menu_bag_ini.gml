function menu_bag_ini() {
  ...
  //Lets Say we have a battle pocket, common item poket, AG pocket,
  ...
  //Now we want to fill the array with the maxamum value of items the bag can fit
  //so we just use a "for" statment to do that with a random var.
  ///////////////////////////////////////////////////////////////////////////////
  ...
  for (a = 0; a <= global.maxitems[0]; a += 1)
    for (b = 0; b <= global.maxitems[1]; b += 1)
      for (c = 0; c <= global.maxitems[2]; c += 1) global.inventory[0, a] = 0;
